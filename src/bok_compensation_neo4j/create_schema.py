...
CONSTRAINTS = [
    ...
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:보수기준) REQUIRE n.보수코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:직책급기준) REQUIRE n.직책급코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:상여금기준) REQUIRE n.상여금코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:연봉차등액기준) REQUIRE n.연봉차등액코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:연봉상한액기준) REQUIRE n.연봉상한액코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:임금피크제기준) REQUIRE n.임금피크제코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:국외본봉기준) REQUIRE n.국외본봉코드 IS UNIQUE",
    "CREATE CONSTRAINT IF NOT EXISTS FOR (n:초임호봉기준) REQUIRE n.초임호봉코드 IS UNIQUE",
