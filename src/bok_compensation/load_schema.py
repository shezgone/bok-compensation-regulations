        ...
        with session.transaction(TransactionType.WRITE) as tx:
            ...
            tx.query.insert("""
                ...
                $a3 isa 수당,
                    ...
                    has 수당설명 "정규 근무시간 초과 근무에 대한 수당", has 지급률 1.5;
                $a4 isa 수당,
                    has 수당코드 "A004", has 수당명 "특별근무수당", has 수당유형 "정액",
                    has 수당설명 "휴일 또는 야간 근무에 대한 수당";
                $a5 isa 수당,
                    has 수당코드 "A005", has 수당명 "정근수당", has 수당유형 "비율",
                    has 수당설명 "근속연수에 따라 지급하는 수당", has 지급률 0.5;
            """)

            # --- 근무형태 ---
            tx.query.insert("""
                insert
                $w1 isa 근무형태, has 근무형태코드 "W01", has 근무형태명 "정규근무", has 근무시간 8.0,
                    has 보수기준설명 "09:00~18:00 정규 근무";
                $w2 isa 근무형태, has 근무형태코드 "W02", has 근무형태명 "탄력근무", has 근무시간 8.0,
                    has 보수기준설명 "출퇴근 시간 자율 조정 (총 8시간)";
                $w3 isa 근무형태, has 근무형태코드 "W03", has 근무형태명 "시간선택제", has 근무시간 4.0,
                    has 보수기준설명 "일 4시간 단축근무";
            """)
